...
/**
 * Created by zhangbang on 16/12/13.
 */
public class BScaleImageView extends ImageView
{
    private String TAG = "BScaleImageView";
    //初始狀態的Matrix
    ...
    public BScaleImageView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    //圖片縮放設定
    public void build_image(Bitmap mBitmap)
    {
            ...
            public boolean onTouch(View v, MotionEvent event)
            {
                ...
                switch(event.getAction() & MotionEvent.ACTION_MASK)
                {
                    ...
                    case MotionEvent.ACTION_MOVE :
                        ...
                        Log.d(TAG, "---------------ACTION_MOVE:" + mState);
                        break;
                }

                //將mMatrix滑動縮放控制帶入
                BScaleImageView.this.setImageMatrix(mMatrix);
                //縮放設定
                Scale();
